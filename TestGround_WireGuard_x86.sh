...
[Nn]* ) echo "Installation wird abgebrochen";rm TestGround_WireGuard_x86.sh;exit ;;
esac
   
   
# Holt und installiert alle notwendigen WireGuard Pakete
echo -e "\033[31m Download der benoetigten Pakete\033[0m"
wget https://raw.githubusercontent.com/smeagel73/TestGround/master/TestGround_WireGuard_x86.tar.gz -O /root/TestGround_WireGuard_x86.tar.gz &>/dev/null
tar -xvzf /root/TestGround_WireGuard_x86.tar.gz
...
rm /root/TestGround_WireGuard_x86.tar.gz
...
rm TestGround_WireGuard_x86.sh
